...
class AudioStreamTrack(AudioStreamTrack):
    """Audio stream track for capturing microphone audio"""
    ...
    def __init__(self, sample_rate=48000, channels=2):
        ...
        # Frame timing
        self.samples_per_frame = int(self.sample_rate / 50)  # 20ms frames
    ...
    async def recv(self):
        ...
        try:
            ...
            try:
                ...
                # Return silence frame with correct shape (1, samples * channels)
